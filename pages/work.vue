<template>
  <div class="!h-[100dvh] h-screen bg-gray-600"><h1>Work SITE</h1></div>
...
<template>
  ...
  <AtomsWrapper html-tag="section" y-padding="none" x-padding="none" class="overflow-hidden">
    <template #default>
      <MoleculesProjectSlider :items="sliderItems" />
    </template>
  </AtomsWrapper>
</template>
